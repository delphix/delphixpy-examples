...
from delphixpy.v1_8_2.web import user
from delphixpy.v1_8_2.web import job
from delphixpy.v1_8_2.web.vo import JSDataContainerCreateParameters
from delphixpy.v1_8_2.web.vo import JSDataSourceCreateParameters
from delphixpy.v1_8_2.web.vo import JSTimelinePointBookmarkInput
from delphixpy.v1_8_2.web.vo import JSDataContainerModifyOwnerParameters
from delphixpy.v1_8_2.web.vo import JSDataContainerDeleteParameters
...
def create_container(dlpx_obj, template_name, container_name, database_name):
    ...
    try:
        ...
        print_info('JS Container {} was created successfully.'.format(
            container_name))
...
def list_containers(dlpx_obj):
    ...
    try:
        ...
        for js_container in js_containers:
            ...
            print_info('{}, {}, {}, {}, {}, {}'.format(js_container.name,
                       js_container.active_branch, str(js_container.owner),
                       str(js_container.reference), str(js_container.template),
                       last_updated))
