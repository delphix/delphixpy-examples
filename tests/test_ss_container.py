...
class SelfServiceContainerTests(unittest.TestCase):
    ...
    def _create_container(self):
        return ss_container.create_container(
            self.server_obj, self.data_template, self.container_name, self.database_name
        )
    ...
    def _delete_container(self, create_ref):
        ...
        selfservice.container.delete(
            self.server_obj.server_session, create_ref, delete_params
        )
    ...
    def test_create_add_remove_users_ss_container(self):
        ...
        ss_container.add_owner(self.server_obj, self.owner_name, self.container_name)
        ss_container.remove_owner(self.server_obj, self.owner_name, self.container_name)
    ...
    def test_restore_and_reset_container(self):
        ...
        data_layout_obj = self._find_ref(selfservice.container, self.container_name)
        ...
        ss_container.restore_container(
