...
def update_branch(branch_name):
    ...
    try:
        ...
        print_exception('\nERROR: The branch %s could not be updated. The '
                        'error was:\n\n{}'.format(branch_name, e))
